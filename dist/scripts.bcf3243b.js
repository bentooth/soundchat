...
},{"@firebase/app":"../node_modules/@firebase/app/dist/index.cjs.js"}],"firebase/firebaseConfiguration.js":[function(require,module,exports) {
"use strict";
...
var firebaseConfig = {
  apiKey: 'AIzaSyBR1RG0E0-vsP9k-2jrmXSXLrCMK5r0SHc',
  authDomain: 'sound-chat-339f0.firebaseapp.com',
  databaseURL: 'https://sound-chat-339f0.firebaseio.com',
  projectId: 'sound-chat-339f0',
  storageBucket: 'sound-chat-339f0.appspot.com',
  messagingSenderId: '857141026216',
  appId: '1:857141026216:web:bea2773ed51d136ab1119d'
};
...
},{"@firebase/auth":"../node_modules/@firebase/auth/dist/auth.js"}],"scripts/utilities.js":[function(require,module,exports) {
"use strict";
...
},{"firebase/app":"../node_modules/firebase/app/dist/index.cjs.js","firebase/auth":"../node_modules/firebase/auth/dist/index.esm.js"}],"firebase/firebaseAuthentication.js":[function(require,module,exports) {
"use strict";
...
var twitterSignin = function twitterSignin() {
  var provider = new _app.default.auth.TwitterAuthProvider();

  _app.default.auth().signInWithPopup(provider).then(function (result) {
    return console.log('successfully logged in ', result.user.displayName);
  }).catch(function (error) {
    return console.error('There was an error when signing in with Twitter: ', error);
  });
};

exports.twitterSignin = twitterSignin;
